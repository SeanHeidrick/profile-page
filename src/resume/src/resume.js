    ...
    <>
      ...
      <main className="App">
        <section className="objective">
          ...
          <p>
            Self-taught individual with leadership experience and a passion for
            learning looking to transition into a career in web development. Has
            two years of experience with JavaScript and is searching for a team
            to contribute to while growing technical skills in React and other
            languages.
          </p>
        </section>
        ...
        <section className="coding-experience">
          ...
          <div>
            ...
            <p>
              Developed a consumer-facing website using React and React-Router.
              This affiliate website assists musicians so they may find and
              purchase their dream guitar pedal; built using performant and
              reliable vanilla JS design patterns within a React environment.
            </p>
          </div>
          <div>
            <h4 className="project-title">Todo List</h4>
            <p>
              Built an accessible productivity application using React and React
              hooks for application state management. Users are able to add,
              edit, and remove items in their lists. Future features include
              custom theming and user sign-up to persist data.
            </p>
          </div>
          <div>
